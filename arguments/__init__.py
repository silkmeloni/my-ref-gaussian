...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.mv_material_from_iter = 20000
        ...
        self.mv_material_depth_thr = 0.01
        self.mv_material_alpha_thr = 0.5
        self.mv_material_normal_thr = 45.0
        self.mv_material_w_albedo = 1.0
        self.mv_material_w_roughness = 0.05
        self.mv_material_w_refl = 0.05
